...
EXTRA_ARGS=("$@")
# Support both generic torchrun-style envs and Volcano/MLP envs.
NUM_MACHINES="${NNODES:-${MLP_WORKER_NUM:-1}}"
MACHINE_RANK="${NODE_RANK:-${MLP_ROLE_INDEX:-0}}"
MAIN_PROCESS_IP="${MASTER_ADDR:-${MLP_WORKER_0_HOST:-127.0.0.1}}"
MAIN_PROCESS_PORT="${MASTER_PORT:-${MLP_WORKER_0_PORT:-29500}}"
