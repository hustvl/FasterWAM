...
from fasterwam.utils.video_io import save_mp4
...
def get_libero_env(task, resolution, seed, env_num=1):
    ...
    env_args = {
        # LIBERO-Plus performs string operations on this value. Standard
        # LIBERO also accepts the explicit string path.
